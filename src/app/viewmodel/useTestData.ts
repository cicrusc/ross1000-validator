...
export const generateTestData = (): RossRecord[] => {
    const testRecords: RossRecord[] = [
        // Record 1: Ospite Singolo senza camere (dovrebbe essere errore)
        {
            ...
            field_7: ' '.repeat(9),
            field_8: ' '.repeat(2),
            field_9: '100000100', // Codice corretto per l'Italia (9 cifre)
            field_10: '100000100', // Codice corretto per l'Italia (9 cifre)
            field_11: ' '.repeat(9), // Dovrebbe essere errore: residente in Italia senza comune residenza
            field_12: ' '.repeat(2), // Dovrebbe essere errore: residente in Italia senza provincia
            field_13: '100000100', // Codice corretto per l'Italia (9 cifre)
            field_14: ' '.repeat(50),
            field_15: ' '.repeat(5),
            field_16: ' '.repeat(20),
            field_17: ' '.repeat(9),
